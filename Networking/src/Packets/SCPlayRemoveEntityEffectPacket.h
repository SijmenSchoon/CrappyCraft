...
namespace Networking
{
    ...
    {
        /// <summary>
        ///     Sent whenever a status effect (potion effect) is to be applied from an entity.
        /// </summary>
        ...
        public:
            ...
            // TODO: Give this enum its own header.
            ...
            /// <summary>
            ///     The ID of the entity the effect is to be removed from.
            /// </summary>
            int32_t mEntityID;
